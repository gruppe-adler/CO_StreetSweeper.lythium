...
class BWFleck {
    ...
    class Type {
        ...
        class soldier_A_F: Soldier_F {
            backpack = "ARC_GER_Kitbag_compact_Flecktarn";
            addItemsToBackpack[] = {
                LIST_3("hlc_100Rnd_762x51_B_MG3"),
            };
        };
        ...
        class crew_F: Soldier_F {
          uniform = "GER_Flecktarn_Officer_Uniform";
          vest = "ARC_GER_Flecktarn_Plate_Carrier_H";
          backpack = "";
          headgear = "H_HelmetCrew_B";
      		primaryWeapon = "rhsusf_weap_MP7A2_desert";
